            ...
            <div class="col-12">
                <div class="well">
                    <div class="page-header">
                        <h1>A Fancy Header <small>A subhead's for extra awesome</small></h1>
                    </div><!-- ./end page header-->
                    <p class="lead">Some solid copy will help get you some users engaged. Use this area to come up with something real nice.
                    ...
                    <a href="" class="btn btn-lg btn-primary">Click a nice big button</a>
